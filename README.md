...
bash
   mvn compile
Ejecutá la clase Principal desde tu IDE (botón Run) o mediante Maven.
🎯 Cómo se usa
Al iniciar, aparece el menú principal:
   ...
   2) Iniciar Sesion
   3) Salir
Registrate (opción 1) creando un usuario y contraseña.
Iniciá sesión (opción 2) con esas credenciales.
Completá misiones para ganar XP y subir de nivel.
🔮 Próximas mejoras
